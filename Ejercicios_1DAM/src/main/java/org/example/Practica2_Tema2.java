...
public class Practica2_Tema2 {
    static void main() {
        ...
        }else if (operacion.equals("+") || operacion.equals("-") || operacion.equals("x") || operacion.equals("/") ) {//en caso de que eligas otra operación que no sea la raíz cuadrada hará este camino y te pedirá un segundo número
